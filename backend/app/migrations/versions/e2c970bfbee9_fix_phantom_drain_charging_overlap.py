"""fix_phantom_drain_charging_overlap

Revision ID: e2c970bfbee9
Revises: 51eeee5e29ed
...
revision: str = 'e2c970bfbee9'
down_revision: Union[str, None] = '51eeee5e29ed'
...
def upgrade() -> None:
    ...
    soc_changes AS (
        ...
        -- EXCLUDE any period where charging happened (SoC increase)
        -- OR where any intermediate charging_state was not 'DISCONNECTED'
