    ...
    <div className="bg-iv-surface/40 border border-iv-border/50 rounded-lg p-4">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        {!isEditing ? (
          ...
          <button type="button" onClick={onEdit} className="text-iv-muted hover:text-iv-text">
          ...
          <div className="flex gap-1">
            ...
            <button type="button" onClick={() => onSave(draft)} disabled={saving} className="text-emerald-400 hover:text-emerald-300">

              {saving ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Save className="w-3.5 h-3.5" />}

            </button>

            <button type="button" onClick={onCancel} className="text-iv-muted hover:text-iv-text">
